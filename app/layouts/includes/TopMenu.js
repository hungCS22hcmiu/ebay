                    ...
                    >
                        <li className="relative px-3">
                            ...
                            <div
                                id="AuthDropDown"
                                className={`
                                    absolute bg-white w-[200px] text-[#333333] z-40 top-[20] left-0 border shadow-lg
                            ...
                            >
                                ...
                                <ul className="bg-white">
                                    ...
                                    <li 
                                        ...
                                        className="text-[11] py-2 px-4 w-full hover:underline text-blue-500 hover:text-blue-600 cursor-pointer"
                                    >
                                        Sign Out
                                    </li>
