    ...
    return(
        <>
           <div className="relative flex justify-start my-2 border w-full p-6">
                <img src={product?.url+'/150'} className="rounded-md w-[150px] h-[150px]"></img>
                <div className="overflow-hidden pl-2 w-full">
                    ...
                    <div className="absolute right-0 bottom-0 p-4 text-sm">
                        <button onClick={() => removeItemFromCart()} className="underline text-blue-500 hover:text-red-500"> Remove</button>
                    </div>
                </div>
           </div>
        </>
